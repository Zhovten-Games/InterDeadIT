...
*InterDead（インターデッド）は、Zhovten Gamesによる心理志向型ホラー・プロジェクトであり、スペキュレイティブ・フィクション（Speculative Fiction／SpecFi）の枠組みの中で展開されています。物語の中心には「死者のためのメッセンジャー」が存在し、その周囲にメタユニバースが徐々に広がっていきます。*
