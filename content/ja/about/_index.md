...
_InterDead は speculative fiction（SpecFi）の枠組みに属する心理志向ホラープロジェクトであり、「死者のためのメッセンジャー」という概念、記憶、そして人間ではないかもしれない意識のあり方を中心に、ゲームとメタユニバースが徐々に形成されていく作品です。ゲーム本編は現在 Zhovten Games により開発中です。あわせて、この世界観はテーブルトークRPGセッションを通じても拡張される予定です。_
