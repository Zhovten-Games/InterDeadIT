...
InterDead は、スペキュレイティブ・フィクション（SpecFi）の枠組みに基づく非営利の心理志向ホラー・プロジェクトであり、現在開発中のゲームと、「死者のためのメッセンジャー」という概念を軸に徐々に展開されるメタユニバースを中心に構築されています。ゲームは Zhovten Games によって開発されています。ゲームと並行して、この世界は予定されているテーブルトークRPGセッションや、複数の作者・複数の形式による寄与を通じても展開されます。
