...
2. [ブログ](http://localhost:1313/ru/blog/)に組み込まれたミニゲームをプレイします。
...
当初、リリースはまさにその時期に合わせて計画されていました。しかしその後、私たちの予算とスケジュールに大きな影響を及ぼす出来事が起こりました。詳細については、別途公開する予定です。

ここでは、Grandma という会社とともに歩んだ道のりを、ひとまず記録しておきたいと思います。妻はそこで4年以上働いており、私たちはその経験と、そこで出会った人々に深く感謝しています。開発チームが手がけたゲームの一部は、もはや当初の形では世に出ないか、あるいは完全にお蔵入りすることになるでしょう。こうした事情は、私たちの「心理志向ホラー・プロジェクト」のスケジュールにも、直接的な影響を与えました。当初の計画よりも遅れて登場する可能性が高いと言わざるをえません。

現在の私たちの状況は、客観的に見てやや不安定です。当初は自己資金で賄う予定だったいくつかの「加速装置」を手放さざるをえませんでした。しかし、これをもって「正式なリリース延期」とみなすのは時期尚早でしょう。むしろ、サードパーティのインフラ的「ほうれん草」に頼るのではなく、まずは自前のリソースに依拠するモードへと移行している、と表現するほうが適切です。

とはいえ、プロジェクト自体は凍結されていません。日々の生活リズムがどうであれ、InterDead は毎日、小さくとも実態のある更新を受け続けています。そして現時点で、これを中止する計画はありません。
