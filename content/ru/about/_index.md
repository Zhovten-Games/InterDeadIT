...
*InterDead — это психологически ориентированный хоррор-проект студии Zhovten Games, развиваемый в рамках спекулятивной фантастики (Speculative Fiction, SpecFi). В его центре — история «мессенджера для мёртвых», вокруг которого постепенно формируется мета-вселенная.*
