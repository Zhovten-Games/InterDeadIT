...
_InterDead — психологически ориентированный хоррор-проект в рамках speculative fiction (SpecFi), сосредоточенный на разработке игры и мета-вселенной, постепенно формирующейся вокруг концепции «мессенджера для мёртвых», памяти и форм сознания, которые могут быть нечеловеческими. Игра в настоящее время разрабатывается студией Zhovten Games. Параллельно вселенную также планируется расширять через настольные ролевые сессии._
...
Материалы InterDead содержат темы, которые могут быть эмоционально тяжёлыми или нежелательными:

- смерть;
- утрата близкого;
- чёрный юмор;
- война и военная тематика;
- безумие / психическая дезорганизация;
- суицид;
- искусственный интеллект;
- принуждение и утрата автономии (действия человека против его воли);
- хоррор;
- спекулятивная фантастика (SpecFi);
- жестокие сцены убийства;
- религиозные мотивы.

Если подобный контент вам неприятен или может быть травмирующим, рекомендуем не продолжать знакомство с проектом.

Материалы предназначены для взрослых (18+ или возраст совершеннолетия в вашей юрисдикции).
...
Рабочий конспект программы Лейбница 1666 года (глоссарий + краткое пояснение):
...
Не было никакого выстрела в воздух: я просто сел и начал. Я набросал прототип и концептуальный каркас инструмента, вокруг которого выстроена вся драматургия, — приложения, созданного учёным, который годами пытался установить контакт с мёртвыми. В какой-то момент ему это удалось, хотя и не в форме интимного разговора с конкретным умершим человеком. Более широкий контекст этой фигуры, а также внутренняя логика приложения и его вымышленная родословная изложены в вики проекта, где эти элементы представлены как части связной концептуальной модели. При её формировании мы опирались на разные культурные и литературные ориентиры — в том числе на тексты Клайва Баркера (Books of Blood, Pulse и др.), в которых граница между «там» и «здесь» ведёт себя как плохо прошитая молния. Эти работы важны для понимания настроения и образности проекта, но отмечу, что они не являются источником сюжетной или структурной логики.
...
После серии обсуждений с нейросетью я разработал [PsyFramework](https://github.com/Zhovten-Games/PsyFramework) — фреймворк, позволяющий рассматривать страхи через академическую оптику причин и триггеров. Подробное описание методологии можно найти в отдельном [посте в LinkedIn](https://www.linkedin.com/posts/zhovten-games_psyframework-horrorgames-gamedev-activity-7390063601119551489-HlSj?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFdDiTQBZ3sD2HwR_iilyxTEnTlROhLelmM).
