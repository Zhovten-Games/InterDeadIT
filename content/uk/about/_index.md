...
*InterDead — це психологічно орієнтований горор-проєкт студії Zhovten Games, створений у межах спекулятивної фантастики (Speculative Fiction, SpecFi). В його основі — історія «месенджера для мертвих», навколо якої поступово вибудовується мета-всесвіт.*
