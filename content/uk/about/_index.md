...
_InterDead — це психологічно орієнтований горор-проєкт у межах speculative fiction (SpecFi), зосереджений на розробці гри та мета-всесвіту, що поступово формується навколо концепції «месенджера для мертвих», пам’яті та форм свідомості, які можуть бути не людськими. Гра наразі розробляється студією Zhovten Games. Паралельно всесвіт також планується розширювати через настільно-рольові сесії._
...
Робочий конспект програми Лейбніца 1666 року (глосарій + коротке пояснення):
...
Не було жодного пострілу в повітря: я просто сів і почав. Я накидав прототип і концептуальний каркас інструмента, навколо якого вибудувана вся драматургія, — застосунку, створеного вченим, який роками намагався встановити контакт із мертвими. У певний момент йому це вдалося, хоча й не у формі інтимної розмови з конкретною померлою людиною.

Ширший контекст цієї постаті, а також внутрішня логіка застосунку та його вигадана родовідна структура зафіксовані у вікі проєкту, де ці елементи подані як частини цілісної концептуальної моделі. Під час її формування ми спиралися на різні культурні та літературні орієнтири — зокрема на тексти Клайва Баркера (_Books of Blood_, _Pulse_ та інші), у яких межа між «там» і «тут» поводиться як погано прошита блискавка. Ці роботи важливі для розуміння настрою та образності проєкту, однак вони не є джерелами його сюжетної чи структурної логіки.

Наразі проєкт підтримує дві публічні вікі:
...
У них зафіксовані внутрішня логіка застосунку, використовувана термінологія та концептуальна структура.
...
Наразі наша ситуація об’єктивно менш стабільна. Нам довелося відмовитися від частини раніше запланованих прискорювальних кроків, які передбачалося реалізувати за рахунок особистих ресурсів. У поточних умовах проєкт розвивається обережніше та поступово, з переглядом темпів і пріоритетів порівняно з початковими планами.
